...
const (
	...
	UserService_GetByID_FullMethodName        = "/auth.UserService/GetByID"
)
...
func (c *userServiceClient) GetByID(ctx context.Context, in *ById, opts ...grpc.CallOption) (*UserRes, error) {
	out := new(UserRes)
...
func (UnimplementedUserServiceServer) GetByID(context.Context, *ById) (*UserRes, error) {
